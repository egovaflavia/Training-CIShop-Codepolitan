	...
	<div class="row">
		<div class="col-md-9">
					...
					<div class="card mb-3">
						<div class="card-body">
							...
							<span class="float-right">
								Urutakan Harga:
								<a href="#" class="badge badge-primary">Termurah</a>
								|
								<a href="#" class="badge badge-primary">Termahal</a>
							</span>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="card mb-3">
						<img src="http://placehold.co/100x70" alt="No Image" class="card-img-top">
						<div class="card-body">
						...
						<div class="card-body">
							<form action="">
								<div class="input-group">
									...
									<div class="input-group-append">
										<buntt class="btn btn-primary">Cari</buntt>
									</div>
								</div>
							</form>
						</div>
